                ...
                <div className="max-w-[1022px] flex flex-col gap-6 mx-auto">
                    {FAQ_DATA_LIST.map((item, index) => (
                        <div className={`rounded-xl  ${active === index ? 'bg-custom p-[1px]' : ''}`}>
                            <div key={index} className={`rounded-xl !bg-wood-smoke border gap-4 sm:px-6 border-solid border-dark-blue transition-all ease-linear duration-500 ${active === index ? '!border-none' : ''}`}>
