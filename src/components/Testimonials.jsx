                ...
                {TESTINOMIALS_LIST.map((obj, i) => (
                    <SwiperSlide key={i}>
                        <div className="w-full min-w-[364px] slider-bg-color rounded-t-3xl pt-6 px-6 pb-10">
                            ...
                            <p
                                className={`text-white text-base font-normal leading-6 opacity-80 pt-2 max-md:max-w-none ${i === 1 ? "max-w-[325px]" : "max-w-[316px]"
                                    }`}
                            >
                                {obj.description}
                            </p>
                            <div
                                className={`flex items-center gap-2  ${i === 2 ? "mt-6" : "mt-[47px]"
                                    }`}
                            >
