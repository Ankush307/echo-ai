            ...
            <div className="max-w-[1138px] mx-auto">
                <div className="flex max-lg:flex-wrap justify-center gap-y-10 max-md:gap-[30px]">
                    {RESULTS_LIST.map((item, index) => (
                        <div className={`w-4/12 max-lg:w-1/2 max-md:w-full justify-center flex max-md:pr-0 pr-[17px] border-right border-solid ${index === 1 ? "max-lg:border-r-0" : index === 2 ? "!border-r-0 max-lg:w-full max-lg:pr-0 " : ""}`}>
