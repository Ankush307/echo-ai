    ...
    return (
        <div className='flex flex-col items-center bg-cover bg-no-repeat bg-center bg-heroBgImg mt-[-1px] '>
            <div className="container mx-auto max-xl:px-4">
                <Header />
                <div className="flex flex-wrap w-full relative lg:pb-[190px] lg:pt-[146px] py-10 max-lg:gap-4">
                    ...
                    <img className='absolute max-sm:w-[200px] md:left-[-10%] top-[60%] left-[-7%] md:top-[2%] pointer-events-none' src="./assets/images/webp/hero-side-circle.webp" alt="" />
                </div>
            </div>
        </div>
    )
